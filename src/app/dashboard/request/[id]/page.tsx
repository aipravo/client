							...
							{subscription.is_active
								...
								(
									<>
										...
										<h5 className=' text-center text-md-start'>Удачи! 🚀</h5>
									</>
								)
								:
								(
									<>
										...
										<div className="card-header bg-primary text-white text-center">
											<h2>Инструкция по правильному запросу ассистенту</h2>
										</div>
										<div className="card-body">
											...
											<p>
												...
												<br />
												<strong>Хорошо:</strong> &quot;Составь договор аренды коммерческого помещения в Алматы между
												физическим и юридическим лицом, с учетом права выкупа через 3 года. Укажи обязанности
												сторон, порядок расторжения и ответственность за нарушение условий.&quot;
											</p>

											<h4>2. Указывайте детали</h4>
											<ul>
												<li><strong>Тип документа:</strong> договор, иск, жалоба, ходатайство.</li>
												<li><strong>Стороны:</strong> физические лица, ИП, ТОО, госорганы.</li>
												<li><strong>Основные условия:</strong> срок, сумма, ответственность, права и обязанности.</li>
												<li><strong>Юридическая база:</strong> какие законы и статьи учитывать.</li>
												<li><strong>Дополнительные требования:</strong> нужны ли особые условия или пункты.</li>
											</ul>
											...
											<ol>
												<li>&quot;Составь первую часть договора – преамбулу и предмет договора.&quot;</li>
												<li>&quot;Теперь добавь обязанности сторон и ответственность.&quot;</li>
												<li>&quot;Допиши заключительные положения и реквизиты.&quot;</li>
											</ol>

											<h4>4. Если ответ короткий – уточняйте!</h4>
											<ul>
												<li>&quot;Раскрой подробнее все разделы.&quot;</li>
												<li>&quot;Добавь ссылки на законы и разверни формулировки.&quot;</li>
												<li>&quot;Опиши больше деталей, например, ответственность за нарушение.&quot;</li>
											</ul>
											...
											<p>
												Если вам нужны ссылки на законы, обязательно укажите: &quot;Составь исковое заявление с учетом
